...
export const Banner = ({title, author, cover, tags, description} : Card) => {
    return (
        <>
        <article className='relative bg-cover bg-center w-full h-full flex-shrink-0 flex-grow-0 py-[1rem] px-[2rem]' style={{backgroundImage:`url(${cover})` }}>
            ...
            <div className="flex flex-col  text-white p-[2rem]] gap-y-[1.5rem] sm:p-[1.5rem] relative z-10">
                ...
                <div className='flex h-[22vh] gap-x-[1.5rem] md:!h-[40vh]'>
                    <picture className='group flex items-start relative mb-auto select-none min-w-[160px] w-full h-full !h-[10rem] 
                        ...
                        <img src={cover} alt="banner_img" className='h-full w-full'/>
                    </picture>
